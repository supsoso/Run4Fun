...
use r4f\UserBundle\Entity\Level;
use r4f\UserBundle\Form\LevelType;
...
class LevelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('r4fUserBundle:Level')->findAll();

        return $this->render('r4fUserBundle:Level:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('r4fUserBundle:Level')->find($id);
        ...
        return $this->render('r4fUserBundle:Level:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('r4fUserBundle:Level:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('r4fUserBundle:Level:edit.html.twig', array(
            'entity'      => $entity,
